...
#$(combo_target)RELEASE_CFLAGS := -O3 -g -fno-strict-aliasing -fno-tree-vectorize -fno-inline-functions -fno-unswitch-loops -floop-flatten -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block
